...
const EmployeeList = () => {
  ...
  const [showModal, setShowModal] = useState(false);
    ...
    // Simpan ke state atau API call di sini
  };
    ...
    <div className="col mt-5">
      <div className="p-4 card shadow">
        ...
        <div className="d-flex justify-content-between mb-3">
          ...
          <AddEmployeeModal show={showModal} handleClose={() => setShowModal(false)} handleSave={handleSave} />
        </div>

        {/* Card Grid */}
        <Row>
          {filteredEmployees.slice(0, showResult).map(emp => (
            <Col key={emp.id} xs={6} sm={4} md={3} lg={2} className="mb-4 position-relative">
